...
Defined in: [electron/utils/monitoring/monitorLifecycle.ts:625](https://github.com/Nick2bad4u/Uptime-Watcher/blob/main/electron/utils/monitoring/monitorLifecycle.ts#L625)
...
Optional monitor ID (if not provided, stops all monitors
  for the site)
