...
@public`,methods:[],displayName:`FormField`,props:{children:{required:!0,tsType:{name:`ReactNode`},description:`Form input element(s) to wrap`},required:{defaultValue:{value:`false`,computed:!1},required:!1}},composes:[`FormFieldBaseProperties`]}})),y,b,x,S=t((()=>{y=e(n()),i(),p(),v(),b=a(),x=(0,y.memo)(function({children:e,error:t,helpText:n,id:i,label:a,required:o=!1}){let s=d(a,o),c=f(i,t,n),l={"aria-label":s,...c&&{"aria-describedby":c}};return(0,b.jsx)(_,{...r(t)&&{error:t},...r(n)&&{helpText:n},id:i,label:a,required:o,children:e(l)})}),x.__docgenInfo={description:`Base form field component with common FormField wrapper and ARIA logic.
