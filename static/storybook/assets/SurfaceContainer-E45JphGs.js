...
@defaultValue "md"`,defaultValue:{value:`"lg"`,computed:!1}},role:{required:!1,tsType:{name:`string`},description:`Explicit ARIA role to apply when the component becomes interactive.`},rounded:{required:!1,tsType:{name:`union`,raw:`| "full"
| "lg"
| "md"
| "none"
| "sm"
...
@defaultValue "md"`,defaultValue:{value:`"lg"`,computed:!1}},shadow:{required:!1,tsType:{name:`union`,raw:`| "inner"
| "lg"
| "md"
| "sm"
...
@defaultValue \\{ \\} (internal singleton)`},surface:{required:!1,tsType:{name:`union`,raw:`| "base"
| "elevated"
