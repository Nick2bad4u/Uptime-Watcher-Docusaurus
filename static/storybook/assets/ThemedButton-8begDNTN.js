...
@internal`,methods:[],displayName:`renderColoredIcon`}})),h,g,_,v,y,b=t((()=>{h=e(n()),a(),m(),s(),g=o(),_={},v=({"aria-disabled":e,"aria-label":t,children:n,className:a=``,"data-testid":o,disabled:s=!1,form:l,fullWidth:d=!1,icon:f,iconColor:p,iconPosition:m=`left`,loading:v=!1,onClick:y,size:b=`md`,style:x=_,title:S,type:C,value:w,variant:T=`primary`,...E})=>{let D=C&&C!==`button`?{type:C}:void 0,O=i([c.THEMED_BUTTON,`themed-button--${T}`,`themed-button--size-${b}`,d&&`themed-button--full-width`,(s?!0:v)&&`themed-button--loading`,a].filter(Boolean),` `),k=(0,h.useCallback)(e=>{y?.(e)},[y]),A=()=>{if(v)return(0,g.jsxs)(`div`,{className:`themed-button__loading`,children:[(0,g.jsx)(`div`,{className:`themed-button__spinner`}),(0,g.jsx)(`span`,{children:n})]});if(f){let e=p?u(f,p):f;return n?m===`left`?(0,g.jsxs)(g.Fragment,{children:[e,(0,g.jsx)(`span`,{children:n})]}):(0,g.jsxs)(g.Fragment,{children:[(0,g.jsx)(`span`,{children:n}),e]}):(0,h.isValidElement)(e)?e:(0,g.jsx)(`span`,{children:e})}return!r(n)||n===!1?null:(0,h.isValidElement)(n)?n:(0,g.jsx)(`span`,{children:n})};return(0,g.jsx)(`button`,{"aria-disabled":e,"aria-label":t,className:O,"data-testid":o??(t?`button-${t.toLowerCase().replaceAll(/\s+/gu,`-`)}`:void 0),disabled:s?!0:v,form:l,onClick:k,style:x,title:S,type:`button`,value:w,...E,...D,children:A()})},y=(0,h.memo)(v),v.__docgenInfo={description:`Themed button component with comprehensive styling and state management.
