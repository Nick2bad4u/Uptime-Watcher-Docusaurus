import{a as e,n as t}from"./rolldown-runtime-DaJ6WEGw.js";import{t as n}from"./react-DvlgmmzG.js";import{M as r,k as i,t as a}from"./distribution-BnO2nqjU.js";import{n as o,t as s}from"./types-BjH8OlvW.js";var c,l,u,d,f=t((()=>{c=e(n()),a(),o(),l={},u=({"aria-label":e,as:t=`div`,border:n=!1,children:a,className:o=``,"data-testid":u,onClick:d,onMouseEnter:f,onMouseLeave:p,open:m,padding:h=`md`,role:g,rounded:_=`md`,shadow:v,style:y=l,surface:b=`base`,tabIndex:x,variant:S=`primary`,...C})=>{let w=r([s.THEMED_BOX,`themed-box--background-${S}`,`themed-box--surface-${b}`,`themed-box--padding-${h}`,`themed-box--rounded-${_}`,v&&`themed-box--shadow-${v}`,n&&`themed-box--border`,o].filter(Boolean),` `),T=!!d,E=e=>{e.key!==`Enter`&&e.key!==` `||!d||(e.preventDefault(),d())},D={...C,className:w,"data-testid":u,onMouseEnter:f,onMouseLeave:p,style:y,...i(m)&&{open:m}},O=T?{onClick:d,...t===`div`&&{"aria-label":e,onKeyDown:E,role:g??`button`,tabIndex:x??0},...t===`button`&&{"aria-label":e,type:`button`}}:{};return(0,c.createElement)(t,{...D,...O},a)},d=(0,c.memo)(u),u.__docgenInfo={description:`Themed box component for container layout and visual consistency.
...
visibility using the native HTML dialog \`open\` attribute.`},padding:{required:!1,tsType:{name:`union`,raw:`| "lg"
| "md"
| "sm"
| "xl"
| "xs"`,elements:[{name:`literal`,value:`"lg"`},{name:`literal`,value:`"md"`},{name:`literal`,value:`"sm"`},{name:`literal`,value:`"xl"`},{name:`literal`,value:`"xs"`}]},description:`Padding size variant.

@defaultValue "md"`,defaultValue:{value:`"md"`,computed:!1}},role:{required:!1,tsType:{name:`string`},description:`Explicit ARIA role to apply when the component becomes interactive.`},rounded:{required:!1,tsType:{name:`union`,raw:`| "full"
| "lg"
| "md"
| "none"
| "sm"
| "xl"`,elements:[{name:`literal`,value:`"full"`},{name:`literal`,value:`"lg"`},{name:`literal`,value:`"md"`},{name:`literal`,value:`"none"`},{name:`literal`,value:`"sm"`},{name:`literal`,value:`"xl"`}]},description:`Border radius variant.

@defaultValue "md"`,defaultValue:{value:`"md"`,computed:!1}},shadow:{required:!1,tsType:{name:`union`,raw:`| "inner"
| "lg"
| "md"
| "sm"
| "xl"`,elements:[{name:`literal`,value:`"inner"`},{name:`literal`,value:`"lg"`},{name:`literal`,value:`"md"`},{name:`literal`,value:`"sm"`},{name:`literal`,value:`"xl"`}]},description:`Shadow depth variant. When omitted, no shadow class is added.`},style:{required:!1,tsType:{name:`CSSProperties`},description:`Inline style object forwarded to the element.

@defaultValue \\{ \\} (internal singleton)`,defaultValue:{value:`{}`,computed:!1}},surface:{required:!1,tsType:{name:`union`,raw:`| "base"
| "elevated"
| "overlay"`,elements:[{name:`literal`,value:`"base"`},{name:`literal`,value:`"elevated"`},{name:`literal`,value:`"overlay"`}]},description:`Surface variant used to select contextual surface styles.
...
component is interactive, a sensible default is applied.`},variant:{required:!1,tsType:{name:`union`,raw:`| "primary"
| "secondary"
| "tertiary"`,elements:[{name:`literal`,value:`"primary"`},{name:`literal`,value:`"secondary"`},{name:`literal`,value:`"tertiary"`}]},description:`Visual variant used to choose background styling.

@defaultValue "primary"`,defaultValue:{value:`"primary"`,computed:!1}},className:{defaultValue:{value:`""`,computed:!1},required:!1}},composes:[`AccessibilityProperties`,`CoreComponentProperties`,`DataAttributeProperties`,`DomIdentityProperties`]}}));export{f as n,d as t};