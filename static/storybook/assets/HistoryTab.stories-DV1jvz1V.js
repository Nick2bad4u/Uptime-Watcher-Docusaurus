var y=Object.defineProperty;var n=(o,t)=>y(o,"name",{value:t,configurable:!0});import{H as u}from"./HistoryTab-BjuPI4Pt.js";import{b as l}from"./siteStoryHelpers-CD_Eu4XO.js";import"./jsx-runtime-BHIWlbBZ.js";import"./iframe-CreBuNPk.js";import"./preload-helper-Cc2_yIPf.js";import"./useTheme-BeZpuX1q.js";import"./storeErrorHandling-D4oToydn.js";import"./react-DiIGpqgH.js";import"./EventsService-BjxJj59F.js";import"./useUiStore-BfFuR8Wt.js";import"./stringSafety-3narqytt.js";import"./utfByteLength-Dk-7ijHQ.js";import"./StatusIndicator-Dalt1106.js";import"./icons-D_Q_f2rV.js";import"./ThemedButton-CW7lHQyb.js";import"./types-B6zT3oaC.js";import"./ThemedCard-CgODs_UP.js";import"./ThemedBox-Cg_UbnDy.js";import"./ThemedText-BJI_SxX2.js";import"./ThemedSelect-nxk03xHF.js";import"./useThemedControlStyles-uHO119ZE.js";import"./MonitorUiComponents-DKmpCqqk.js";import"./monitorUiHelpers-AknUfLO9.js";import"./validation-at8F_Jpu.js";import"./useSitesStore-iyNVQL90.js";const{expect:s,userEvent:p,within:w}=__STORYBOOK_MODULE_TEST__,f=n(o=>new Intl.DateTimeFormat("en-US",{day:"2-digit",hour:"2-digit",minute:"2-digit",month:"short"}).format(new Date(o)),"formatFullTimestamp"),v=n(o=>`${o} ms`,"formatResponseTime"),m=l({history:Array.from({length:24},(o,t)=>({responseTime:120+t%5*30,status:t%6===0?"degraded":"up",timestamp:Date.now()-t*6e4})),id:"monitor-http",responseTime:132,status:"up"}),h={...m,history:m.history.map((o,t)=>t<6?{...o,responseTime:500+t*40,status:t<3?"down":"degraded"}:o),status:"down"},T={...m,history:[]},G={args:{formatFullTimestamp:f,formatResponseTime:v,selectedMonitor:m},component:u,parameters:{layout:"fullscreen"},tags:["autodocs"]},a={play:n(async({canvasElement:o,step:t})=>{const r=w(o);await t("Verify initial history summary",async()=>{const e=await r.findByText(/24 of 24 records/i);s(e).not.toHaveTextContent(/\(down filter\)/i)}),await t("Filter to down records",async()=>{const e=await r.findByRole("button",{name:/down/i});await p.click(e);const d=await r.findByText(/0 of 24 records/i);s(d).toHaveTextContent(/\(down filter\)/i)}),await t("Adjust visible history count",async()=>{const e=r.getByRole("combobox");await p.selectOptions(e,"10"),s(e).toHaveValue("10");const d=await r.findByText(/0 of 24 records/i);s(d).toHaveTextContent(/\(down filter\)/i)})},"play")},i={args:{selectedMonitor:h}},c={args:{selectedMonitor:T},parameters:{docs:{description:{story:"Illustrates a brand new monitor where checks have not yet produced any history records."}}}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
  play: async ({
    canvasElement,
    step
  }) => {
