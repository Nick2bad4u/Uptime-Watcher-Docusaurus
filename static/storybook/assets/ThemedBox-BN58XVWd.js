import{i as e,s as t}from"./preload-helper-CT_b8DTk.js";import{M as n,k as r,t as i}from"./distribution-ruwBHiZP.js";import{Rn as a}from"./iframe-DlbQ3f5p.js";import{n as o,t as s}from"./types---wUWNDL.js";var c,l,u,d,f=e((()=>{c=t(a()),i(),o(),l={},u=({"aria-label":e,as:t=`div`,border:i=!1,children:a,className:o=``,"data-testid":u,onClick:d,onMouseEnter:f,onMouseLeave:p,open:m,padding:h=`md`,role:g,rounded:_=`md`,shadow:v,style:y=l,surface:b=`base`,tabIndex:x,variant:S=`primary`,...C})=>{let w=n([s.THEMED_BOX,`themed-box--background-${S}`,`themed-box--surface-${b}`,`themed-box--padding-${h}`,`themed-box--rounded-${_}`,v&&`themed-box--shadow-${v}`,i&&`themed-box--border`,o].filter(Boolean),` `),T=!!d,E=e=>{e.key!==`Enter`&&e.key!==` `||!d||(e.preventDefault(),d())},D={...C,className:w,"data-testid":u,onMouseEnter:f,onMouseLeave:p,style:y,...r(m)&&{open:m}},O=T?{onClick:d,...t===`div`&&{"aria-label":e,onKeyDown:E,role:g??`button`,tabIndex:x??0},...t===`button`&&{"aria-label":e,type:`button`}}:{};return(0,c.createElement)(t,{...D,...O},a)},d=(0,c.memo)(u),u.__docgenInfo={description:`Themed box component for container layout and visual consistency.
