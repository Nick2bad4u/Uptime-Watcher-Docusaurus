import{a as e,n as t}from"./rolldown-runtime-DaJ6WEGw.js";import{t as n}from"./react-DvlgmmzG.js";import{k as r,t as i}from"./distribution-BnO2nqjU.js";import{h as a,t as o}from"./constants-QHtczVmK.js";import{t as s}from"./jsx-runtime-cM__dR4X.js";import{i as c,r as l,t as u}from"./useTheme-DurDzRTo.js";import{n as d,t as f}from"./useThemedControlStyles-DP-zfXJE.js";var p,m,h,g,_=t((()=>{p=e(n()),i(),a(),u(),f(),m=s(),h=({"aria-describedby":e,[o]:t,className:n=``,disabled:i=!1,id:a,max:s,min:u,onChange:f,placeholder:h,required:g=!1,step:_,type:v=`text`,value:y})=>{let{currentTheme:b}=l(),{getBackgroundClass:x,getBorderClass:S,getTextClass:C}=c(),w=y??``,T=d((0,p.useMemo)(()=>({currentTheme:b,disabled:i,fluid:!0,getBackgroundClass:x,getBorderClass:S,getTextClass:C,tone:`default`}),[b,i,x,S,C]));return(0,m.jsx)(`input`,{"aria-describedby":e,"aria-label":t,className:`themed-input ${n}`,"data-testid":a?`input-${a}`:void 0,disabled:i,id:a,max:s,min:u,onChange:f,placeholder:h,required:g,step:_,style:T,type:v,...r(y)?{value:w}:{}})},g=(0,p.memo)(h),h.__docgenInfo={description:`Themed input component with consistent styling and accessibility support.
