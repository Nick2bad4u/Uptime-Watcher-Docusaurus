import{a as e,n as t}from"./chunk-BneVvdWh.js";import{Qt as n}from"./iframe-CAh388JZ.js";import{t as r}from"./jsx-runtime-Bn1Ys6_W.js";import{n as i,t as a}from"./ThemedButton-D1o_Roas.js";import{r as o,t as s}from"./icons-B14S2C6F.js";import{n as c,t as l}from"./Tooltip-CDdLyT0T.js";var u,d,f,p=t((()=>{u=e(n()),i(),o(),c(),d=r(),f=(0,u.memo)(function({allMonitorsRunning:e,className:t=``,compact:n=!1,disabledReason:r,isLoading:i,onStartSiteMonitoring:o,onStopSiteMonitoring:c,size:f=`sm`}){let p=(0,u.useCallback)(e=>{e?.stopPropagation(),c()},[c]),m=(0,u.useCallback)(e=>{e?.stopPropagation(),o()},[o]),h=f===`xs`?14:16,g=s.actions.pauseFilled,_=s.actions.playAll,v=(0,u.useCallback)(e=>r===`unconfigured`?`${e} • Configure a monitor to enable this control.`:r===`loading`?`${e} • Finishing the previous request.`:e,[r]);return e?(0,d.jsx)(l,{content:v(`Stop monitoring all monitors for this site`),position:`top`,children:e=>(0,d.jsxs)(a,{...e,"aria-label":`Stop All Monitoring`,className:`flex items-center gap-1 ${t}`,disabled:i,onClick:p,size:f,variant:`error`,children:[(0,d.jsx)(g,{size:h}),!n&&(0,d.jsx)(`span`,{className:`hidden text-xs sm:inline`,children:`Stop All`})]})}):(0,d.jsx)(l,{content:v(`Start monitoring all monitors for this site`),position:`top`,children:e=>(0,d.jsxs)(a,{...e,"aria-label":`Start All Monitoring`,className:`flex items-center gap-1 ${t}`,disabled:i,onClick:m,size:f,variant:`success`,children:[(0,d.jsx)(_,{size:h}),!n&&(0,d.jsx)(`span`,{className:`hidden text-xs sm:inline`,children:`Start All`})]})})}),f.displayName=`SiteMonitoringButton`,f.__docgenInfo={description:`Reusable site monitoring button that handles start/stop all monitoring.
