import{i as e,s as t}from"./preload-helper-CT_b8DTk.js";import{xn as n}from"./iframe-CuB8g8Z1.js";import{t as r}from"./jsx-runtime-DqZldVDK.js";import{n as i,t as a}from"./ThemedButton-DWYVM3XF.js";var o,s,c,l,u=e((()=>{o=t(n()),i(),s=r(),c=({className:e=``,disabled:t=!1,icon:n,iconColor:r,loading:i=!1,onClick:c,size:l=`md`,tooltip:u,variant:d=`ghost`,...f})=>{let p=(()=>{switch(l){case`lg`:return`48px`;case`md`:return`40px`;case`sm`:return`32px`;case`xl`:return`56px`;case`xs`:return`24px`;default:return`40px`}})(),m=(0,o.useMemo)(()=>({height:p,minWidth:`unset`,padding:`0`,width:p}),[p]);return(0,s.jsx)(a,{className:`themed-icon-button ${e}`,disabled:t,loading:i,size:l,variant:d,...c&&{onClick:c},icon:n,...r&&{iconColor:r},style:m,...u&&{title:u},...f})},l=(0,o.memo)(c),c.__docgenInfo={description:`A themed icon button component optimized for displaying only icons
