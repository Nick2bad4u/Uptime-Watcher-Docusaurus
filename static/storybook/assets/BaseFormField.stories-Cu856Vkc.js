import{n as e}from"./chunk-BneVvdWh.js";import{t}from"./jsx-runtime-Bn1Ys6_W.js";import{n,t as r}from"./BaseFormField-DDd_XKyV.js";var i,a,o,s,c,l,u;e((()=>{n(),i=t(),a=e=>(0,i.jsx)(`input`,{...e,className:`w-64 rounded-xs border border-slate-400 px-3 py-2`,defaultValue:``,placeholder:`Enter a descriptive name`,type:`text`}),o={args:{children:a,id:`site-name`,label:`Site Name`,required:!0},component:r,parameters:{docs:{description:{component:`BaseFormField wraps inputs with shared label/help/error affordances while emitting ARIA attributes for the trigger element.`}},layout:`centered`},argTypes:{children:{control:!1}},tags:[`autodocs`]},s={args:{children:a},parameters:{docs:{description:{story:`Demonstrates the default required presentation; the generated aria-label marks the field as mandatory without duplicating the visual asterisk.`}}}},c={args:{children:a,helpText:`This name appears in dashboards and alerts.`},parameters:{docs:{description:{story:`Shows the optional help hint bound through aria-describedby, ensuring screen readers announce usage guidance after the label.`}}}},l={args:{children:a,error:`Provide a unique site name.`},parameters:{docs:{description:{story:`Error messaging remains inside the labelled container and is connected to the input via aria-describedby for assistive feedback.`}}}},s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  args: {
