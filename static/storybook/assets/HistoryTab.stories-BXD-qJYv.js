import{n as e}from"./chunk-BneVvdWh.js";import{i as t,t as n}from"./siteStoryHelpers-iAn6BQcA.js";import{n as r,t as i}from"./HistoryTab-a8F_h3h8.js";var a,o,s,c,l,u,d,f,p,m,h,g,_;e((()=>{r(),t(),{expect:a,userEvent:o,within:s}=__STORYBOOK_MODULE_TEST__,c=e=>new Intl.DateTimeFormat(`en-US`,{day:`2-digit`,hour:`2-digit`,minute:`2-digit`,month:`short`}).format(new Date(e)),l=e=>`${e} ms`,u=n({history:Array.from({length:24},(e,t)=>({responseTime:120+t%5*30,status:t%6==0?`degraded`:`up`,timestamp:Date.now()-t*6e4})),id:`monitor-http`,responseTime:132,status:`up`}),d={...u,history:u.history.map((e,t)=>t<6?{...e,responseTime:500+t*40,status:t<3?`down`:`degraded`}:e),status:`down`},f={...u,history:[]},p={args:{formatFullTimestamp:c,formatResponseTime:l,selectedMonitor:u},component:i,parameters:{layout:`fullscreen`},tags:[`autodocs`]},m={play:async({canvasElement:e,step:t})=>{let n=s(e);await t(`Verify initial history summary`,async()=>{a(await n.findByText(/24 of 24 records/i)).not.toHaveTextContent(/\(down filter\)/i)}),await t(`Filter to down records`,async()=>{let e=await n.findByRole(`button`,{name:/down/i});await o.click(e),a(await n.findByText(/0 of 24 records/i)).toHaveTextContent(/\(down filter\)/i)}),await t(`Adjust visible history count`,async()=>{let e=n.getByRole(`combobox`);await o.selectOptions(e,`10`),a(e).toHaveValue(`10`),a(await n.findByText(/0 of 24 records/i)).toHaveTextContent(/\(down filter\)/i)})}},h={args:{selectedMonitor:d}},g={args:{selectedMonitor:f},parameters:{docs:{description:{story:`Illustrates a brand new monitor where checks have not yet produced any history records.`}}}},m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`{
  play: async ({
    canvasElement,
    step
  }) => {
